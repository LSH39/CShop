...
/**
 * Servlet implementation class ProductCheckUpdateServlet
 */
@WebServlet(name = "ProductCheckUpdate", urlPatterns = { "/productCheckUpdate" })
public class ProductCheckUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductCheckUpdateServlet() {
        super();
